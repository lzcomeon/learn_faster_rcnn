...
class FasterRCNNVGG16(FasterRCNN):
    ...
    Args:
        ...
        anchor_scales (list of numbers): This is areas of anchors.
            Those areas will be the produce of the square of an element in
    ...
    def __init__(self,
        ...
        print('-------------faster_rcnn_vgg16_init__-----------------------')
...
class VGG16RoIHead(nn.Module):
    ...
    This outputs class-wise localizations and classification based feature
    ...
    Args:
        ...
        classifier (nn.Module): Twoe layer Linear ported from vgg16
    """
    ...
    def forward(self, x, rois, roi_indices):
        ...
        Args:
            ...
            rois (Tensor): A bounding box array containing coordinates of
                ...
                Its shape is (`R`, 4), Given
            roi_indices (tensor): An array containing indices of images to
                which bounding boxes correspong to. Its shape is ('R',)
