...
class RegionProposalNetwork(nn.Module):
    ...
    def forward(self, x, img_size, scale=1.):
        ...
        Here are notations
        * N: is batch size
        * C: channnel size of the input
        * H, W : are height and width of the input feature
        * A: is the number of anchors assigned to each pixel
        ...
        Args:
            ...
            scale (float): The amount of scaling done to the input images
                after reading them from files
...
# anchor = _enumerate_shifted_anchor(rpn.anchor_base, rpn.feat_stride,
#                                    14, 18)
# print(anchor.shape)
